...
def emi():
    if request.method == "POST":
        ...
        try:
            ...
            print(f"Total_item_amt: {Total_item_amt}, down_payment: {down_payment}, interest_rate: {interest_rate}, loan_tenure: {loan_tenure}")
            ...
            print(f"Yearly_Amount: {Yearly_Amount}, BreakUp: {BreakUp}")
            ...
            print(f"Error during EMI calculation: {e}")
            return redirect('/emi/results')  # or handle the error as needed
...
def emi_results():
    ...
    return render_template('emi.html', Yearly=Yearly_Amount, BreakUp=BreakUp, Formdetails=Formdetails,name=session.get('name', ''))
